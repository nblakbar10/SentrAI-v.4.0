...
def putarsuara():
    objeknya = CLASSES[idx]
    while True:
        if (objeknya == "orang"):
            play(AudioSegment.from_wav("orang.wav"))
            break
        elif (objeknya == "botol"):
            play(AudioSegment.from_wav("botol.wav"))
            break
        elif (objeknya == "kursi"):
            play(AudioSegment.from_wav("kursi.wav"))
            break
        elif (objeknya == "kucing"):
            play(AudioSegment.from_wav("kucing.wav"))
            break
        elif (objeknya == "motor") :
            play(AudioSegment.from_wav("motor.wav"))
            break
        elif (objeknya == "mobil") :
            play(AudioSegment.from_wav("mobil.wav"))
            break
        break
